...
#pragma warning disable IDE1006
    ...
    public partial class dBaseIntf_pg
    {
        ...
        public void dbSalvaDati()
        {
            ...
            try
            {
                // se il database non esiste ... come in dbSalvaOrdine ma con il PgSqlDataReader
                ...
                if (bDBConnection_Ok) // se la connessione non è OK evita solo messagggi di errore
                {
                    ...
                    PgSqlTransaction transaction = _Connection.BeginTransaction();

                    // riempie dataTable con tutte le colonne
                    sQueryTxt = "SELECT * FROM " + _sDBTNameDati + ";";
                    PgSqlDataAdapter dbDataAdapterSelect = new PgSqlDataAdapter(sQueryTxt, _Connection);
                    ...
                    PgSqlDataAdapter dbDataAdapter = new PgSqlDataAdapter();
                    PgSqlParameter parm;
                    ...
                    dbDataAdapter.UpdateCommand = new PgSqlCommand(sQueryTxt, _Connection);
                    ...
                    dbDataAdapter.UpdateCommand.Parameters.Add("@iPrezzo_Unitario", PgSqlType.Int, 10, "iPrezzo_Unitario");
                    dbDataAdapter.UpdateCommand.Parameters.Add("@iQuantita_Venduta", PgSqlType.Int, 10, "iQuantita_Venduta");
                    dbDataAdapter.UpdateCommand.Parameters.Add("@iQuantita_Scaricata", PgSqlType.Int, 10, "iQuantita_Scaricata");
                    dbDataAdapter.UpdateCommand.Parameters.Add("@sDisponibilita", PgSqlType.VarChar, 10, "sDisponibilita");
                    dbDataAdapter.UpdateCommand.Parameters.Add("@iGruppo_Stampa", PgSqlType.Int, 10, "iGruppo_Stampa");
                    dbDataAdapter.UpdateCommand.Parameters.Add("@sText", PgSqlType.VarChar, 50, "sText");

                    parm = dbDataAdapter.UpdateCommand.Parameters.Add("@oldId", PgSqlType.Int, 11, "iRiga_ID");
                    ...
                    if ((dataRow != null))
                    {
                        ...
                        iDebug = SF_Data.iNumOfLastReceipt - SF_Data.iStartingNumOfReceipts;
                    }
                    else
                        bNoProblem = false;
        ...
        public bool dbCreaTableDati()
        {
            ...
            try
            {
                ...
                sQueryTxt = String.Format(@"CREATE TABLE IF NOT EXISTS {0} (""iRiga_ID"" INT NOT NULL, ""sTipo_Articolo"" VARCHAR(50),      
                            ""iPrezzo_Unitario"" INT NOT NULL, ""iQuantita_Venduta"" INT NOT NULL,
                            ""iQuantita_Scaricata"" INT NOT NULL, ""sDisponibilita"" VARCHAR(10),
                            ""iGruppo_Stampa"" INT NOT NULL, ""sText"" VARCHAR(50),
                ...
                sQueryTxt = "INSERT INTO " + _sDBTNameDati +
                                @" (""iRiga_ID"", ""sTipo_Articolo"", ""iPrezzo_Unitario"", ""iQuantita_Venduta"", ""iQuantita_Scaricata"", 
                                ""sDisponibilita"", ""iGruppo_Stampa"", ""sText"") VALUES 
                                (@iRiga_ID, @sTipo_Articolo, @iPrezzo_Unitario, @iQuantita_Venduta, @iQuantita_Scaricata, @sDisponibilita, 
                                @iGruppo_Stampa, @sText);";

                dbDataAdapter.InsertCommand = new PgSqlCommand(sQueryTxt, _Connection);

                dbDataAdapter.InsertCommand.Parameters.Add("@iRiga_ID", PgSqlType.Int, 11, "iRiga_ID");
                dbDataAdapter.InsertCommand.Parameters.Add("@sTipo_Articolo", PgSqlType.VarChar, 50, "sTipo_Articolo");
                dbDataAdapter.InsertCommand.Parameters.Add("@iPrezzo_Unitario", PgSqlType.Int, 10, "iPrezzo_Unitario");
                dbDataAdapter.InsertCommand.Parameters.Add("@iQuantita_Venduta", PgSqlType.Int, 10, "iQuantita_Venduta");
                dbDataAdapter.InsertCommand.Parameters.Add("@iQuantita_Scaricata", PgSqlType.Int, 10, "iQuantita_Scaricata");
                dbDataAdapter.InsertCommand.Parameters.Add("@sDisponibilita", PgSqlType.VarChar, 10, "sDisponibilita");
                dbDataAdapter.InsertCommand.Parameters.Add("@iGruppo_Stampa", PgSqlType.Int, 10, "iGruppo_Stampa");
                dbDataAdapter.InsertCommand.Parameters.Add("@sText", PgSqlType.VarChar, 50, "sText");
        ...
        public void dbUpdateHeadOrdine()
        {
            ...
            PgSqlDataAdapter dbDataAdapter;
            ...
            try
            {
                ...
                dbDataAdapterSelect = new PgSqlDataAdapter(sQueryTxt, _Connection);
            ...
            try
            {
                if ((iNumRowsOrdini > 0) && bDBConnection_Ok)
                {
                    ...
                    {
                        UpdateCommand = new PgSqlCommand(sQueryTxt, _Connection)
                    };

                    dbDataAdapter.UpdateCommand.Parameters.Add("@sText", PgSqlType.VarChar, 50, "sText");
                    dbDataAdapter.UpdateCommand.Parameters.Add("@iStatus", PgSqlType.Int, 10, "iStatus");

                    dbDataAdapter.UpdateCommand.Parameters.Add("@oldId", PgSqlType.VarChar, 50, "sTipo_Articolo").SourceVersion = DataRowVersion.Original;
                    dbDataAdapter.UpdateCommand.UpdatedRowSource = UpdateRowSource.None;
        ...
        public void dbSalvaOrdine(bool bCreateHead = false)
        {
            ...
            PgSqlDataAdapter dbDataAdapterSelect = null;
            PgSqlDataAdapter dbDataAdapterInsert = null;
            ...
            try
            {
                ...
                dbDataAdapterInsert = new PgSqlDataAdapter();
                ...
                sQueryTxt = "INSERT INTO " + _sDBTNameOrdini +
                                @" (""iOrdine_ID"", ""sTipo_Articolo"", ""iPrezzo_Unitario"", ""iQuantita_Ordine"", ""iIndex_Listino"", ""sText"", 
                                    ...
                                    VALUES (@iOrdine_ID, @sTipo_Articolo, @iPrezzo_Unitario, @iQuantita_Ordine, @iIndex_Listino, @sText, 
                                    @iGruppo_Stampa, @iStatus, @iNumCassa, @iScaricato, @sScaricato, @iAnnullato, @sAnnullato);";

                dbDataAdapterInsert.InsertCommand = new PgSqlCommand(sQueryTxt, _Connection);

                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iOrdine_ID", PgSqlType.Int, 11, "iOrdine_ID");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@sTipo_Articolo", PgSqlType.VarChar, 50, "sTipo_Articolo");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iPrezzo_Unitario", PgSqlType.Int, 10, "iPrezzo_Unitario");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iQuantita_Ordine", PgSqlType.Int, 10, "iQuantita_Ordine");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iIndex_Listino", PgSqlType.Int, 10, "iIndex_Listino");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@sText", PgSqlType.VarChar, 50, "sText");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iGruppo_Stampa", PgSqlType.Int, 10, "iGruppo_Stampa");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iStatus", PgSqlType.Int, 10, "iStatus");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iNumCassa", PgSqlType.Int, 10, "iNumCassa");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iScaricato", PgSqlType.Int, 10, "iScaricato");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@sScaricato", PgSqlType.VarChar, 10, "sScaricato");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iAnnullato", PgSqlType.Int, 10, "iAnnullato");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@sAnnullato", PgSqlType.VarChar, 10, "sAnnullato");
            ...
            try
            {
                ...
                // se il database non esiste ... come in dbSalvaDati ma con il PgSqlDataAdapter
                ...
                if ((iNumRowsOrdini == 0) && bDBConnection_Ok)
                {
                     ...
                     *
                     *  iNumCassa INT deve essere NOT NULL
                    ...
                    sQueryTxt = String.Format(@"CREATE TABLE IF NOT EXISTS {0} (""iOrdine_ID"" INT NOT NULL, ""sTipo_Articolo"" VARCHAR(50) NOT NULL,        
                                        ""iPrezzo_Unitario"" INT, ""iQuantita_Ordine"" INT, ""iIndex_Listino"" INT,
                                        ""sText"" VARCHAR(400), ""iGruppo_Stampa"" INT, ""iStatus"" INT, ""iNumCassa"" INT NOT NULL,
                                        ""iScaricato"" INT, ""sScaricato"" VARCHAR(10), ""iAnnullato"" INT, ""sAnnullato"" VARCHAR(10)); ", _sDBTNameOrdini);
        ...
        public void dbSalvaMessaggio(String[] rVisMessaggiLines, String sNomeFileMsg)
        {
            ...
            try
            {
                ...
                sMessage = sMessage.Replace("'", "''"); // prepara la query PostgreSQL
        ...
        public void dbSalvaListino()
        {
            ...
            PgSqlDataAdapter dbDataAdapterSelect = null;
            PgSqlDataAdapter dbDataAdapterIns = null;
            ...
            try
            {
                ...
                dbDataAdapterIns = new PgSqlDataAdapter();

                sQueryTxt = "INSERT INTO " + NOME_LISTINO_DBTBL + " (\"iRiga_ID\", \"sText\") VALUES (@iRiga_ID, @sText);";

                dbDataAdapterIns.InsertCommand = new PgSqlCommand(sQueryTxt, _Connection);

                dbDataAdapterIns.InsertCommand.Parameters.Add("@iRiga_ID", PgSqlType.Int, 10, "iRiga_ID");
                dbDataAdapterIns.InsertCommand.Parameters.Add("@sText", PgSqlType.VarChar, 50, "sText");

...
#pragma warning disable IDE1006
    ...
    public partial class dBaseIntf_pg
    {
        ...
        public int dbCaricaDatidaOrdini(DateTime dateParam, int iNumCassaParam, bool bSilentParam = false, String sNomeTabellaParam = "", int iReportParam = 0)
        {
            ...
            PgSqlCommand cmd_Dati = new PgSqlCommand();
            PgSqlDataReader readerDati = null;

            PgSqlCommand cmd_Ordini = new PgSqlCommand();
                        ...
                        while (readerOrdine.Read())
                        {
                            ...
                            for (i = 0; i < iLastArticoloDBIndexP1; i++)
                            {
                                ...
                                else
                                {
                                    ...
                                    sDebug = DB_Data.Articolo[i].sTipo;
                                    ...
                                    if ((DB_Data.Articolo[i].sTipo == sTipo) || (sTipo == ORDER_CONST._DISCOUNT))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            iDebug = DB_Data.iTotaleIncasso;
                                            // Console.WriteLine("dbCaricaDatidaOrdini: DB_Data.iTotaleIncasso = {0}", DB_Data.iTotaleIncasso);
        ...
        public bool dbCaricaDisponibilità(DateTime dateParam)
        {
            ...
            PgSqlCommand cmd = new PgSqlCommand();
            PgSqlDataReader readerDisp = null;
        ...
        public bool dbCaricaMessaggio(int iParam, bool bTutteCassaParam)
        {
            ...
            PgSqlCommand cmd = new PgSqlCommand();
            PgSqlDataReader readerMessaggio;

...
#pragma warning disable IDE0059
        ...
        public bool ReceiptRebuild(DateTime dateParam, int iParam)
        {
            ...
            // importante la priorità, in ordine di gravità, gestione diversi colori
            if (bOrdineAnnullato)
            {
            ...
            else if (!bSomePayment_IsPresent && (DB_Data.iNumCassa == SF_Data.iNumCassa))
            {
            ...
            else if (DB_Data.bScaricato && (DB_Data.iNumCassa != SF_Data.iNumCassa))
            {
                ...
                if (SF_Data.iNumCassa == CASSA_PRINCIPALE)
                    ...
                    AnnulloBtn.Enabled = false; // già consegnato ed emesso da una CASSA_SECONDARIA diversa
            }

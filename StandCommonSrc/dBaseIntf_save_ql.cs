...
#pragma warning disable IDE1006
        ...
        public void dbSalvaDati()
        {
            ...
            try
            {
                // se il database non esiste ... come in dbSalvaOrdine ma con il SQLiteDataReader
                ...
                if (bDBConnection_Ok) // se la connessione non è OK evita solo messagggi di errore
                {
                    ...
                    SQLiteDataAdapter dbDataAdapterSelect = new SQLiteDataAdapter(sQueryTxt, _Connection);
                    ...
                    sQueryTxt = "UPDATE " + _sDBTNameDati +
                        ...
                        ""iQuantita_Venduta"" = @iQuantita_Venduta, ""sDisponibilita"" = @sDisponibilita, ""iGruppo_Stampa"" = @iGruppo_Stampa, 
                        ""sText"" = @sText WHERE ""iRiga_ID"" = @oldId;";

                    dbDataAdapter.UpdateCommand = new SQLiteCommand(sQueryTxt, _Connection);

                    dbDataAdapter.UpdateCommand.Parameters.Add("@iRiga_ID", SQLiteType.Int32, 11, "iRiga_ID");
                    dbDataAdapter.UpdateCommand.Parameters.Add("@sTipo_Articolo", SQLiteType.Text, 50, "sTipo_Articolo");
                    dbDataAdapter.UpdateCommand.Parameters.Add("@iPrezzo_Unitario", SQLiteType.Int32, 10, "iPrezzo_Unitario");
                    dbDataAdapter.UpdateCommand.Parameters.Add("@iQuantita_Venduta", SQLiteType.Int32, 10, "iQuantita_Venduta");
                    dbDataAdapter.UpdateCommand.Parameters.Add("@sDisponibilita", SQLiteType.Text, 10, "sDisponibilita");
                    dbDataAdapter.UpdateCommand.Parameters.Add("@iGruppo_Stampa", SQLiteType.Int32, 10, "iGruppo_Stampa");
                    dbDataAdapter.UpdateCommand.Parameters.Add("@sText", SQLiteType.Text, 50, "sText");

                    parm = dbDataAdapter.UpdateCommand.Parameters.Add("@oldId", SQLiteType.Int32, 11, "iRiga_ID");
        ...
        public bool dbCreaTableDati()
        {
            ...
            try
            {
                ...
                sQueryTxt = String.Format(@"CREATE TABLE IF NOT EXISTS {0} (""iRiga_ID"" INT NOT NULL, ""sTipo_Articolo"" VARCHAR(50),      
                            ""iPrezzo_Unitario"" INT NOT NULL, ""iQuantita_Venduta"" INT NOT NULL, ""sDisponibilita"" VARCHAR(10),
                ...
                sQueryTxt = "INSERT INTO " + _sDBTNameDati +
                                @" (""iRiga_ID"", ""sTipo_Articolo"", ""iPrezzo_Unitario"", ""iQuantita_Venduta"", ""sDisponibilita"", 
                                 ""iGruppo_Stampa"", ""sText"") VALUES 
                                (@iRiga_ID, @sTipo_Articolo, @iPrezzo_Unitario, @iQuantita_Venduta, @sDisponibilita, @iGruppo_Stampa, @sText);";

                dbDataAdapter.InsertCommand = new SQLiteCommand(sQueryTxt, _Connection);

                dbDataAdapter.InsertCommand.Parameters.Add("@iRiga_ID", SQLiteType.Int32, 11, "iRiga_ID");
                dbDataAdapter.InsertCommand.Parameters.Add("@sTipo_Articolo", SQLiteType.Text, 50, "sTipo_Articolo");
                dbDataAdapter.InsertCommand.Parameters.Add("@iPrezzo_Unitario", SQLiteType.Int32, 10, "iPrezzo_Unitario");
                dbDataAdapter.InsertCommand.Parameters.Add("@iQuantita_Venduta", SQLiteType.Int32, 10, "iQuantita_Venduta");
                dbDataAdapter.InsertCommand.Parameters.Add("@sDisponibilita", SQLiteType.Text, 10, "sDisponibilita");
                dbDataAdapter.InsertCommand.Parameters.Add("@iGruppo_Stampa", SQLiteType.Int32, 10, "iGruppo_Stampa");
                dbDataAdapter.InsertCommand.Parameters.Add("@sText", SQLiteType.Text, 50, "sText");
        ...
        public void dbUpdateHeadOrdine()
        {
            ...
            SQLiteDataAdapter dbDataAdapter;
            ...
            try
            {
                if ((iNumRowsOrdini > 0) && bDBConnection_Ok)
                {
                    ...
                    {
                        UpdateCommand = new SQLiteCommand(sQueryTxt, _Connection)
                    };

                    dbDataAdapter.UpdateCommand.Parameters.Add("@sText", SQLiteType.Text, 50, "sText");
                    dbDataAdapter.UpdateCommand.Parameters.Add("@iStatus", SQLiteType.Int32, 10, "iStatus");
        ...
        /// <summary>Salva l'ordine corrente nel database</summary>
        public void dbSalvaOrdine(bool bCreateHead = false)
        {
            ...
            SQLiteDataAdapter dbDataAdapterSelect = null;
            SQLiteDataAdapter dbDataAdapterInsert = null;
            ...
            try
            {
                ...
                dbDataAdapterInsert = new SQLiteDataAdapter();
                ...
                dbDataAdapterInsert.InsertCommand = new SQLiteCommand(sQueryTxt, _Connection);

                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iOrdine_ID", SQLiteType.Int32, 11, "iOrdine_ID");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@sTipo_Articolo", SQLiteType.Text, 50, "sTipo_Articolo");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iPrezzo_Unitario", SQLiteType.Int32, 10, "iPrezzo_Unitario");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iQuantita_Ordine", SQLiteType.Int32, 10, "iQuantita_Ordine");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iIndex_Listino", SQLiteType.Int32, 10, "iIndex_Listino");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@sText", SQLiteType.Text, 50, "sText");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iGruppo_Stampa", SQLiteType.Int32, 10, "iGruppo_Stampa");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iStatus", SQLiteType.Int32, 10, "iStatus");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iNumCassa", SQLiteType.Int32, 10, "iNumCassa");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iScaricato", SQLiteType.Int32, 10, "iScaricato");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@sScaricato", SQLiteType.Text, 10, "sScaricato");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@iAnnullato", SQLiteType.Int32, 10, "iAnnullato");
                dbDataAdapterInsert.InsertCommand.Parameters.Add("@sAnnullato", SQLiteType.Text, 10, "sAnnullato");
            ...
            try
            {
                ...
                // se il database non esiste ... come in dbSalvaDati ma con il SQLiteDataAdapter
                ...
                if ((iNumRowsOrdini == 0) && bDBConnection_Ok)
                {
                    ...
                    sQueryTxt = String.Format(@"CREATE TABLE IF NOT EXISTS {0} (""iOrdine_ID"" INT NOT NULL, ""sTipo_Articolo"" VARCHAR(50) NOT NULL,        
                                        ""iPrezzo_Unitario"" INT, ""iQuantita_Ordine"" INT , ""iIndex_Listino"" INT, ""sText"" VARCHAR(400), 
                                        ""iGruppo_Stampa"" INT, ""iStatus"" INT , ""iNumCassa"" INT NOT NULL, ""iScaricato"" INT, 
                                        ""sScaricato"" VARCHAR(10), ""iAnnullato"" INT, ""sAnnullato"" VARCHAR(10)); ", _sDBTNameOrdini);
...
#endif
                } // if (bDBConnection_Ok && !bCreateHead)

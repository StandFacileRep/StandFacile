        ...
        public bool dbScaricaOrdine(int iOrderID, int iGruppo)
        {
            ...
            if ((iCountOrdini > 0) && !bAnnullato)
            {
                ...
                try // *********** 2 **********
                {
                    ...
                    dbDataAdapterSelect = new MySqlDataAdapter(sQuery, _Connection);
                    ...
                    dbDataAdapter.UpdateCommand = new MySqlCommand(sQuery, _Connection);
                    ...
                    dbDataAdapter.UpdateCommand.Parameters.Add("@oldId", MySqlType.Int, 11, "iRiga_ID").SourceVersion = DataRowVersion.Original;

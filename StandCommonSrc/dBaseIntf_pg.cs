...
#pragma warning disable IDE1006
    ...
    public partial class dBaseIntf_pg
    {
        ...
        public static dBaseIntf_pg _rdBaseIntf_pg;

        /// <summary>connessione per dBaseIntf</summary>
        static PgSqlConnection _Connection;

        PgSqlConnectionStringBuilder _dbCSB = new PgSqlConnectionStringBuilder();

        PgSqlConnection _ConnectionWeb;
        PgSqlConnectionStringBuilder _dbCSB_Web = new PgSqlConnectionStringBuilder();

        /// <summary>ottiene la connessione PostGreSQL</summary>
        public static PgSqlConnection GetDB_Connection() { return _Connection; }
...
#pragma warning disable CS0649
        ...
        public dBaseIntf_pg()
        {
            ...
            if (!(File.Exists(sDir + DB_CONNECTOR_DLL_DEV) && File.Exists(sDir + DB_CONNECTOR_DLL_PG)))
        ...
        public bool dbInit(DateTime dateParam, int iNumCassaParam, bool bSilentParam = false, String sNomeTabellaParam = "")
        {
            ...
            if (bUSA_NDB())
            {
                try
                {
                    ...
                    _Connection = new PgSqlConnection(_dbCSB.ConnectionString);
                    _Connection.Open();
                ...
                catch (Exception)
                {
                    ...
                    _WrnMsg.sMsg = "dbInit PostGreSQL";

                    if (!bSilentParam) // per non accumulare troppe indicazioni
                        WarningManager(_WrnMsg);

                    LogToFile("dbInit : Exception PostGreSQL");
                }
            }
        ...
        public bool dbInitWeb()
        {
            ...
            if (bUSA_NDB())
            {
                try
                {
                    ...
                    _ConnectionWeb = new PgSqlConnection(_dbCSB_Web.ConnectionString);
                    _ConnectionWeb.Open();
                ...
                catch (Exception)
                {
                    // connessione non possibile al database
                    _WrnMsg.iErrID = WRN_DBE;
                    _WrnMsg.sMsg = "dbInit PostGreSQL Web";

                    WarningManager(_WrnMsg);

                    LogToFile("dbInit : Exception PostGreSQL Web");
                }
            }
        ...
        public bool dbCheckStatus(bool bResetParam = false)
        {
            ...
            PgSqlDataReader readerStato = null;
            ...
            if (_sDateFromDB != sActualDateStr)
            {
                ...
                if ((SF_Data.iNumCassa == CASSA_PRINCIPALE) && bResetParam)
                {
                    ...
                    try
                    {
                        ...
                        sQueryTxt = String.Format("INSERT INTO {0} (\"key_ID\", \"sText\", \"iYear\", \"iMonth\", \"iDay\") VALUES (\'{1}\', \'{2}\', {3}, {4}, {5});",
                            NOME_STATUS_DBTBL, WEB_DBASE_NAME_KEY, sWebServerParams.sWeb_DBaseName, 0, 0, 0);
                        cmd.CommandText = sQueryTxt;
                        qResult = cmd.ExecuteScalar();
                        ...
                        sQueryTxt = String.Format(@"CREATE TABLE IF NOT EXISTS {0} (""iOrdine_ID"" INT NOT NULL, ""iNumCassa"" INT NOT NULL, 
        ...
        public bool dbResetNumOfOrders(int iInitialNumOfReceiptsParam)
        {
            ...
            if ((SF_Data.iNumCassa == CASSA_PRINCIPALE) && bUSA_NDB())
            {
                try
                {
                    ...
                    sQueryTxt = String.Format(@"CREATE TABLE IF NOT EXISTS {0} (""iOrdine_ID"" SERIAL,
                                ""iNumCassa"" INT NOT NULL, ""sDataOra"" VARCHAR(50), PRIMARY KEY(""iOrdine_ID"")); ", NOME_NSC_DBTBL);
                    ...
                    if (iInitialNumOfReceiptsParam > 0)
                    {
                        sQueryTxt = String.Format("ALTER SEQUENCE \"{0}_iOrdine_ID_seq\" RESTART WITH {1};", NOME_NSC_DBTBL, iInitialNumOfReceiptsParam);
                        cmd.CommandText = sQueryTxt;
                        qResult = cmd.ExecuteScalar();

                        sTmp = GetActualDate().ToString("yyMMdd");

                        sQueryTxt = String.Format("INSERT INTO {0} (\"iNumCassa\", \"sDataOra\") VALUES ({1}, \'{2}\');",
        ...
        public bool dbResetNumOfMessages(int iInitialNumOfMessagesParam)
        {
            ...
            if ((SF_Data.iNumCassa == CASSA_PRINCIPALE) && bUSA_NDB())
            {
                try
                {
                    ...
                    sQueryTxt = String.Format(@"CREATE TABLE IF NOT EXISTS {0} (""iMsg_ID"" SERIAL,
                                ""iNumCassa"" INT NOT NULL, ""sDataOra"" VARCHAR(50), PRIMARY KEY(""iMsg_ID"")); ", NOME_NMSG_DBTBL);

                    cmd.CommandText = sQueryTxt;
                    qResult = cmd.ExecuteScalar();

                    if (iInitialNumOfMessagesParam > 0)
                    {
                        sQueryTxt = String.Format("ALTER SEQUENCE \"{0}_iMsg_ID_seq\" RESTART WITH {1};", NOME_NMSG_DBTBL, iInitialNumOfMessagesParam);
                        cmd.CommandText = sQueryTxt;
                        qResult = cmd.ExecuteScalar();
        ...
        public int dbGetNumOfPrintedOrders(int iNumOfReceiptParam, bool bModeNextParam)
        {
            ...
            try
            {
                ...
                if (bModeNextParam)
                {
                    cmd.CommandText = String.Format("SELECT \"iOrdine_ID\" FROM " + _sDBTNameOrdini + " WHERE (\"iOrdine_ID\" >= {0}) AND (\"sTipo_Articolo\" = \'{1}\') AND (\"iAnnullato\" = 0) AND (\"iStatus\" & {2} = 0)",
        ...
        public TWebServerParams dbGetWebServerParams()
        {
            ...
            String sKey, sText;
            PgSqlCommand cmd = new PgSqlCommand();
            PgSqlDataReader readerStatus = null;
                ...
                while (readerStatus.Read())
                {
                    ...
                    switch (sKey)
                    {
                        ...
                        case WEB_DBASE_NAME_KEY:
                            sWebServerParams.sWeb_DBaseName = sText;
                            break;
        ...
        public bool dbSetWebServerParams(TWebServerParams sWebServerParams, TWebServerCheckParams sWebServerCheckParams)
        {
            ...
            if (SF_Data.iNumCassa == CASSA_PRINCIPALE)
            {
                try
                {
                    ...
                    cmd.CommandText = "UPDATE " + NOME_STATUS_DBTBL + " SET \"sText\" = '" + sWebServerParams.sWeb_DBaseName + "' WHERE (\"key_ID\" = '" + WEB_DBASE_NAME_KEY + "')";
                    readerStatus = cmd.ExecuteReader();
...
#pragma warning disable IDE0059
        ...
        public bool dbAnnulloOrdine(DateTime dateParam, int iNumAnnulloParam, String sNomeTabellaParam = "")
        {
            ...
            PgSqlCommand cmd = new PgSqlCommand();
            PgSqlDataReader readerOrdini = null;
            ...
            if ((iCount > 0) && (iNumCassa == SF_Data.iNumCassa))
            {
                ...
                try // *********** 2 **********
                {
                    ...
                    dbDataAdapter.UpdateCommand.Parameters.Add("@iAnnullato", PgSqlType.Int, 11, "iAnnullato");
                    dbDataAdapter.UpdateCommand.Parameters.Add("@sAnnullato", PgSqlType.VarChar, 50, "sAnnullato");
        ...
        public String dbCheckListino()
        {
            ...
            using (PgSqlConnection dbConnection = new PgSqlConnection(_dbCSB.ConnectionString))
            {
                try
                {
                    i = 0;
                    ...
                    PgSqlDataReader readerListino = cmd.ExecuteReader();
        ...
        {
            bool bDBConnection_Ok;
            PgSqlDataReader readerTables = null;
            PgSqlCommand cmd = new PgSqlCommand();
            ...
            cmd.CommandText = "SELECT tablename FROM pg_tables WHERE schemaname = 'public' ORDER BY tablename ASC;";
        ...
        public int dbNewOrdineNumRequest()
        {
            ...
            String sQueryTxt;
            PgSqlCommand cmd = new PgSqlCommand();
            PgSqlDataReader readerOrdineNum = null;
        ...
        public int dbNewMessageNumRequest()
        {
            ...
            String sQueryTxt;
            PgSqlCommand cmd = new PgSqlCommand();
            PgSqlDataReader readerMessaggioNum = null;
        ...
        public bool dbCheck(String sDB_ServerNamePrm, String sDB_pwdPrm, bool bSilentParam)
        {
            ...
            catch (Exception)
            {
                ...
                // connessione non possibile al database
                LogToFile("dbPgSqlCheck : dbException dbCheck");
            }
